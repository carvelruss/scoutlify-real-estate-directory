...
const SinglePropertyPage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='Single Property v.1' activeNav='Catalog'>
      {/* Add review modal */}
        ...
        <div className='d-flex justify-content-between align-items-center'>
          ...
          <div className='text-nowrap pb-3'>
            ...
            >
              <Button
                size='xs'
                variant='icon btn-light-primary shadow-sm rounded-circle'
              >
              ...
              <Row className='g-2 g-md-3'>
                ...
                <Col>
                  <GalleryItem
                    ...
                    caption={
                      <>
                        +5 <span className='d-none d-md-inline'>photos</span>
                      </>
                    }
      ...
      <Container as='section' className='mb-5 pb-1'>
        <Row>
          <Col md={7} className='mb-md-0 mb-4'>
            <Badge bg='success' className='me-2 mb-3'>
              Verified
            </Badge>
            ...
            <div className='mb-4 pb-md-3'>
              ...
              <Row
                ...
                md={2}
                lg={3}
                className='list-unstyled gy-1 mb-1 text-nowrap'
              >
            ...
            <div className='mb-4 pb-4 border-bottom'>
              ...
              <div className='d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch justify-content-between'>
                <Button
                  variant='outline-primary mb-sm-0 mb-3'
