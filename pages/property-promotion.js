    ...
    >
      ...
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <Breadcrumb className='mb-3 pt-2 pt-lg-3'>
          ...
          <Breadcrumb.Item linkAs={Link} href='/add-property'>
            Add property
          </Breadcrumb.Item>
        ...
        <h2 className='h3 pb-2 mb-4'>
          Select your perfect plan to promote your ad
        </h2>
          ...
          <Col md={4} className='mb-4'>
            <PricingPlan
              ...
              button={{
                ...
                props: {
                  onClick: () =>
                    console.log('You have chosen Turbo Boost plan'),
                },
              }}
              className='shadow-sm'
            />
