...
const AboutPage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='About' activeNav='Pages'>
      ...
      <Container as='section' className='mb-5 pb-2'>
        <Row className='gy-4 align-items-center justify-content-center'>
          ...
          <Col
            ...
            md={{ span: 6, order: 'first', offset: 1 }}
            lg={7}
          >
            <Swiper
            ...
            >
              <SwiperSlide className='d-flex'>
                <ImageLoader
                  src='/images/real-estate/about/hero/01.jpg'
                  width={792}
                  height={510}
                  alt='Image'
                  className='rounded-3'
              ...
              <SwiperSlide className='d-flex'>
                <ImageLoader
                  src='/images/real-estate/about/hero/02.jpg'
                  width={792}
                  height={510}
                  alt='Image'
                  className='rounded-3'
      ...
      <Container
        as='section'
        className='text-center text-md-start mb-md-4 mb-xl-5 pb-md-4'
      >
          ...
          <Col>
            <Card className='border-0'>
              <Card.Body>
                ...
                <Card.Title as='h5' className='pb-1'>
                  Safety is our priority
                </Card.Title>
                <Card.Text className='mb-0'>
                  Vel et aliquet diam vulputate hendrerit lorem eget amet
                  adipiscing. At ut ut consectetur in sed massa arcu risus sed.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
            ...
            <Card className='border-0'>
              <Card.Body>
                ...
                <Card.Text className='mb-0'>
                  ...
                  Maecenas ultricies laoreet facilisis fusce amet, consequat
                  neque.
                </Card.Text>
              </Card.Body>
            </Card>
            ...
            <Card className='border-0'>
              <Card.Body>
                ...
                <Card.Text className='mb-0'>
                  ...
                  dignissim. Dignissim ultrices scelerisque ultrices nisi.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
        ...
        <Row className='gy-4 pb-2 pb-sm-4'>
          <Col xs={12} md={5} className='text-md-start text-center'>
            <div className='d-inline-block'>
              <ImageLoader
                src='/images/real-estate/illustrations/find.svg'
                width={526}
                height={500}
                alt='Illustration'
              />
            ...
            <div className='steps steps-vertical'>
              <div className='step active'>
                ...
                <div className='step-label ms-4'>
                  ...
                  <p className='mb-0'>
                    Odio velit, massa augue etiam in parturient volutpat orci.
                    Pulvinar amet, at est ac curabitur mauris, semper cursus
                    metus. Imperdiet sed massa amet at turpis. Dis risus, donec
                    in ac ultricies tempor eu, amet.
                  </p>
                </div>
              </div>
              <div className='step active'>
                ...
                <div className='step-label ms-4'>
                  ...
                  <p className='mb-0'>
                    Id orci senectus dignissim magna nec diam bibendum at. Morbi
                    quis turpis nulla condimentum est elementum. Tristique in
                    accumsan eget vestibulum volutpat pretium. Sed id elit duis
                    turpis diam justo. Dignissim blandit rutrum venenatis.
                  </p>
                </div>
              </div>
              <div className='step active'>
                ...
                <div className='step-label ms-4'>
                  ...
                  <p className='mb-0'>
                    Ut mattis nascetur aliquam neque velit nunc sed. Morbi
                    congue mauris amet ultrices molestie tellus proin odio diam.
                    Feugiat elit, habitasse egestas egestas id nec potenti.
                    Donec convallis donec tristique mattis et viverra.
                  </p>
                </div>
              </div>
            </div>
      ...
      <Container as='section' className='mb-5 pb-3 pb-md-4'>
        <div className='d-flex align-items-end justify-content-sm-between justify-content-center mb-3'>
          <h2 className='h3 mb-0 text-sm-start text-center'>
        ...
        <div className='mx-md-n3 mx-n2'>
          ...
          <div
            id='teamPagination'
            className='swiper-pagination position-relative bottom-0 mt-4 mb-lg-3 d-lg-none d-flex'
          ></div>
        </div>
      </Container>
      ...
      <Container as='section' className='mb-5 pb-3 pb-md-4'>
        ...
        <div
          id='partnersPagination'
          className='swiper-pagination position-relative bottom-0 pt-3 pb-md-2'
        ></div>
      </Container>
        ...
        <Row className='g-0 justify-content-center pb-lg-3'>
          <Col xs={12} lg={10} className='position-relative px-3'>
            ...
            >
              <SwiperSlide className='h-auto'>
                <article className='d-flex flex-md-row flex-column h-100 p-3'>
                  <div className='d-md-flex d-none me-4 flex-shrink-0'>
                    <ImageLoader
                      src='/images/real-estate/about/testimonials/01.jpg'
                      width={306}
                      height={260}
                      alt='Image'
                      className='rounded-3'
                  ...
                  <Card className='border-0 shadow-sm h-100'>
                    ...
                    >
                      Eu massa, pharetra massa integer. Sed molestie
                      sollicitudin morbi ultrices. Odio is euismodtelle
                      faucibus. Venenatis nunc, tristique turpis cras sodales.
                      In dui, viverra et ac. Id justo, varius nunc, faucibus
                      erat proin elit. Amet diam, aliquet nec quis vel. Donec ut
                      quisque in lorem sapien luctus pellentesque.
                    </Card.Body>
                  </Card>
                </article>
              </SwiperSlide>
              <SwiperSlide className='h-auto'>
                <article className='d-flex flex-md-row flex-column h-100 p-3'>
                  <div className='d-md-flex d-none me-4 flex-shrink-0'>
                    <ImageLoader
                      src='/images/real-estate/about/testimonials/02.jpg'
                      width={306}
                      height={260}
                      alt='Image'
                      className='rounded-3'
            ...
            <Button
              id='reviewsPrev'
              variant='prev'
              className='d-lg-inline-block d-none mt-n4 ms-n5'
            />
            <Button
              id='reviewsNext'
              variant='next'
              className='d-lg-inline-block d-none mt-n4 me-n5'
            />
            <div
              id='reviewsPagination'
              className='swiper-pagination position-relative bottom-0 mt-lg-0 pt-3 mt-4'
            ></div>
          </Col>
        </Row>
      </Container>
      ...
      <Container as='section' className='mb-5 pb-sm-3 pb-lg-4'>
        <div className='bg-secondary rounded-3'>
          <Col
            xs={12}
            md={{ span: 11, offset: 1 }}
            className='d-flex align-items-center justify-content-between p-md-0 p-2'
          >
            <div
              className='me-md-5 py-md-5 px-md-0 p-4'
            ...
            >
              ...
              <p className='mb-4 pb-md-3 fs-lg'>
                Amet libero morbi venenatis ut est. Iaculis leo ultricies nunc
                id ante adipiscing. Vel metus odio at faucibus ac.
              </p>
              <Button
                as={Link}
            ...
            <Col xs={4} className='d-md-block d-none align-self-end px-0'>
              <div className='d-flex flex-shrink-0 mt-n5'>
                <ImageLoader
                  src='/images/real-estate/about/01.png'
                  width={396}
                  height={442}
                  alt='Cover image'
                />
      ...
      <Container as='section' className='mb-5 pb-3 pb-lg-4'>
        <div className='d-sm-flex align-items-center justify-content-between mb-4 pb-2'>
          ...
          <Button as={Link} href='/blog' variant='link fw-normal ms-sm-3 p-0'>
            Go to blog
        ...
        <div
          id='blogPagination'
          className='swiper-pagination position-relative bottom-0 pt-2 mt-4 mb-lg-4'
        ></div>
      </Container>
