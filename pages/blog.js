...
const BlogPage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='Blog' activeNav='Pages'>
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <h1 className='d-flex align-items-end justify-content-between mb-0'>
          Real estate news
        </h1>
              ...
              <Row as='article' className='gy-3'>
                <Col xs={12} md={7} lg={8}>
                  <Link href={post.href} className='d-block position-relative'>
                    ...
                    <Badge
                      bg='success'
                      className='position-absolute top-0 end-0 m-3 fs-sm'
                    >
                      Sponsored
                    </Badge>
                  </Link>
                ...
                <Col xs={12} md={5} lg={4}>
                  <Link
                    ...
                    className='fs-sm text-uppercase text-decoration-none'
                  >
                    {post.category[1]}
                  </Link>
                  ...
                  <p className='d-md-none d-xl-block mb-4'>{post.text}</p>
                  <Link
                    href={post.author[0]}
                  ...
                  >
                    ...
                    />
                    <div className='ps-2'>
                      <h6 className='fs-base text-nav lh-base mb-1'>
                        {post.author[2]}
                      </h6>
          ...
          >
            <Row xs={2} className='gy-3'>
              <Col
                ...
                className='d-flex flex-sm-row flex-column align-items-sm-center'
              >
        ...
        {/* Pagination */}
        <nav
          className='d-flex pt-4 pb-2 border-top'
