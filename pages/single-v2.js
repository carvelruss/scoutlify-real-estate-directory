...
const SinglePropertyAltPage = () => {
      ...
      <>
        ...
        >
          <SwiperSlide className='d-flex'>
            <ImageLoader
              className='rounded-3'
              src='/images/real-estate/single/09.jpg'
              width={967}
              height={545}
              alt='Image'
            />
          ...
          <SwiperSlide className='d-flex'>
            <ImageLoader
              className='rounded-3'
              src='/images/real-estate/single/10.jpg'
              width={967}
              height={545}
              alt='Image'
            />
          ...
          <SwiperSlide className='d-flex'>
            <ImageLoader
              className='rounded-3'
              src='/images/real-estate/single/11.jpg'
              width={967}
              height={545}
              alt='Image'
            />
          ...
          <SwiperSlide className='d-flex'>
            <ImageLoader
              className='rounded-3'
              src='/images/real-estate/single/12.jpg'
              width={967}
              height={545}
              alt='Image'
            />
          ...
          <SwiperSlide>
            <div className='ratio ratio-16x9'>
              <iframe
                src='https://www.youtube.com/embed/dofyR9p8e7w'
                className='rounded-3'
  ...
  return (
    <RealEstatePageLayout pageTitle='Single Property v.2' activeNav='Catalog'>
      {/* Post content */}
      <Container as='section' className='mt-5 mb-lg-5 mb-4 pt-5 pb-lg-5'>
        ...
        <Breadcrumb className='mb-3 pt-md-3'>
          ...
          <Breadcrumb.Item linkAs={Link} href='/catalog?category=rent'>
            Property for rent
          </Breadcrumb.Item>
        ...
        <Row>
          <Col lg={7} className='pt-lg-2 mb-5 mb-lg-0'>
            <div className='d-flex flex-column'>
              ...
              <div className='order-lg-2 order-1 pt-lg-2'>
                ...
                <p className='mb-2 pb-1 fs-lg'>
                  28 Jackson Ave Long Island City, NY 67234
                </p>
            ...
            <p className='mb-4 pb-2'>
              Etiam ut morbi egestas nunc quis. Nulla tincidunt senectus
              suspendisse neque, sed sem ut donec sed. Nullam hac netus quis nec
              tortor mi auctor risus praesent. In pharetra consequat diam nibh
              consectetur aliquet nulla. Non convallis nascetur viverra viverra
              diam vel bibendum sed. Elementum odio sed etiam consequat
              scelerisque in. Diam sit donec nunc enim. Tellus, commodo eget
              pharetra pharetra quis pellentesque. Enim aliquam sit in porttitor
              sed gravida a. Aliquam ac tellus sit erat. Non, et ac enim felis.
              Proin habitasse sit ut mauris, aliquam ornare pretium, nulla
              aliquam. Scelerisque velit netus quis mauris, dictumst suspendisse
              tortor.
            </p>
            ...
            <Card className='card-horizontal'>
              <div
                ...
                style={{
                  backgroundImage: 'url(/images/real-estate/agents/01.jpg)',
                }}
              ></div>
              <Card.Body as='blockquote' className='blockquote'>
                <p>
                  ...
                  placerat et id ut. Enim aliquam sit in porttitor sed gravida
                  a.
                </p>
          ...
          <Col as='aside' lg={5}>
            <div className='ps-lg-5'>
              ...
              <Card className='border-0 bg-secondary mb-4'>
                <Card.Body>
                  ...
                  <ul className='list-unstyled mt-n2 mb-0'>
                    ...
                    <li className='mt-2 mb-0'>
                      <b>Parking places: </b>2
                    </li>
                    <li className='mt-2 mb-0'>
                      <b>Pets allowed: </b>cats only
                    </li>
                  </ul>
                </Card.Body>
              </Card>
              ...
              <Link
                href='#'
                className='d-inline-block mb-4 pb-2 text-decoration-none'
              >
                ...
                <Card.Body>
                  ...
                  >
                    {amenities[0].map(({ icon, title }, indx) => (
                      <Col key={indx} as='li'>
                        <i
                          className={`${icon} mt-n1 me-2 fs-lg align-middle`}
                        ></i>
                        {title}
                      </Col>
                    ))}
                  ...
                  <Collapse in={amenitiesOpen}>
                    <div id='moreAmenities'>
                      <Row
                        ...
                        md={2}
                        xs={1}
                        className='list-unstyled pt-2 gy-2 mb-0 text-nowrap'
                      >
                  ...
                  <a
                    ...
                    className={`collapse-label d-inline-block mt-3${
              ...
              <ul className='d-flex mb-4 list-unstyled fs-sm'>
                <li className='me-3 pe-3 border-end'>
                  Published: <b>Dec 9, 2021</b>
                </li>
                <li className='me-3 pe-3 border-end'>
                  Ad number: <b>681013232</b>
                </li>
