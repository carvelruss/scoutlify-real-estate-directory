...
const VendorPropertiesPage = () => {
  ...
  return (
    ...
    >
      {/* Message modal */}
      <Modal centered show={messageModalShow} onHide={handleMessageModalClose}>
        <Modal.Header closeButton>
          <Modal.Title as='h3' className='fs-base'>
            Message to Floyd Miles
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form
      ...
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <Row>
          ...
          <Col as='aside' md={4} lg={3} className='mb-5 mb-md-0'>
            <div className='pe-lg-3'>
              ...
              <div className='d-flex justify-content-center justify-content-md-start align-items-center border-bottom pb-4 mb-4'>
                ...
                <Link href='/vendor-reviews' className='ms-2'>
                  45 reviews
                </Link>
              </div>
              <div className='border-bottom pb-4 mb-4'>
                <p className='fs-sm mb-0'>
                  Hello! I will select the best accommodation for you. Amet
                  libero morbi venenatis ut est. Iaculis leo ultricies nunc id
                  ante adipiscing. Vel metus odio at faucibus ac. Neque id
                  placerat et id ut acultricies commodo.
                </p>
                <Collapse in={aboutOpen}>
                  <div id='moreAbout'>
                    <p className='fs-sm mb-0'>
                      Sed ut perspiciatis unde omnis iste natus error sit
                      voluptatem accusantium dolor laudantium, totam rem
                ...
                <div className='text-center text-md-start'>
                  <a
                    ...
                    className={`collapse-label fs-sm${
                      aboutOpen ? '' : ' collapsed'
                    }`}
                  >
          ...
          {/* Page content */}
          <Col md={8} lg={9}>
            <h1 className='h2 text-center text-sm-start mb-4'>
              Property offers
            </h1>
            <div className='d-flex flex-column flex-sm-row align-items-center justify-content-between mb-4'>
              ...
              <Nav variant='tabs' className='flex-nowrap fs-sm mb-sm-0'>
                <Nav.Item>
                  <Nav.Link
                    as={Link}
                    href='/vendor-properties?category=rent'
                    active={categoryParam === 'rent' ? true : false}
                  >
                    For rent
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link
                    as={Link}
                    href='/vendor-properties?category=sale'
                    active={categoryParam === 'sale' ? true : false}
                  >
                    For sale
                  </Nav.Link>
                </Nav.Item>
              ...
              <Form.Group
                controlId='sortby'
                className='d-flex align-items-center flex-shrink-0 ms-sm-4'
              >
            ...
            {/* Properties grid */}
            {categoryParam === 'sale' ? (
              <Row xs={1} sm={2} lg={3} className='g-4 g-md-3 g-lg-4 py-2'>
              ...
              <>
                ...
                <div className='text-center mt-1 pt-4'>
                  <a
                    href='#'
                    className='d-inline-block fw-bold text-decoration-none p-2 pb-0'
                  >
