...
const BlogSinglePage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='Single Post' activeNav='Pages'>
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <div className='mb-4 pb-1'>
          <ul className='list-unstyled d-flex flex-wrap mb-0 text-nowrap'>
            ...
            <li className='me-3'>
              <i className='fi-clock me-2 mt-n1 opacity-60'></i>4 min read
            </li>
            <li className='me-3 border-end'></li>
            <li className='me-3'>
              <ScrollLink
              ...
              >
                <i className='fi-chat-circle me-2 opacity-60'></i>3 comments
              </ScrollLink>
            </li>
          </ul>
        </div>
        ...
        <div className='mb-4 pb-md-3'>
          <ImageLoader
            src='/images/real-estate/blog/single.jpg'
            width={1296}
            height={600}
            alt='Post image'
            className='rounded-3'
        ...
        <Row className='gy-4 pb-3'>
          <Col xs={12} md={1} lg={2} className='mt-md-n4'>
            ...
            <div className='sticky-top py-md-5 mt-md-5'>
              <div className='d-flex flex-md-column align-items-center my-2 mt-md-4 pt-md-5'>
                ...
                <OverlayTrigger
                  placement='top'
                  overlay={<Tooltip>Share with Facebook</Tooltip>}
                >
                  <Button
                    size='xs'
                    variant='icon btn-light-primary rounded-circle shadow-sm mb-md-2 me-md-0 me-2'
                  >
                ...
                <OverlayTrigger
                  placement='top'
                  overlay={<Tooltip>Share with Twitter</Tooltip>}
                >
                  <Button
                    size='xs'
                    variant='icon btn-light-primary rounded-circle shadow-sm mb-md-2 me-md-0 me-2'
                ...
                <OverlayTrigger
                  placement='top'
                  overlay={<Tooltip>Share with LinkedIn</Tooltip>}
                >
                  <Button
                    size='xs'
                    variant='icon btn-light-primary rounded-circle shadow-sm mb-md-2 me-md-0 me-2'
          ...
          <Col xs={12} md={10} lg={8}>
            ...
            <h6>
              ...
              pellentesque sed sed arcu. Neque quam id pellentesque in diam in.
            </h6>
            <p>
              ...
              bibendum. Volutpat elit condimentum integer tortor porttitor justo
              vel lobortis risus. Lacinia pellentesque fermentum tellus orci
              mauris, velit duis eget. Commodo justo, hac ligula molestie felis,
              iaculis. Vitae dui at ante orci, dictum fusce. Urna, sed urna
              fringilla faucibus euismod aliquet nec. Quis libero, fermentum
              amet eu, condimentum auctor. Sit vel ipsum sem tempus gravida et.
              Scelerisque blandit orci, est quis. Nisi, tellus amet est nascetur
              habitant faucibus ornare et vivamus.
            </p>
            <p>
              Convallis massa nunc, tempus eget egestas sollicitudin mauris.
              Purus donec sed neque arcu, dictumst tortor nisi, odio. A sit
              lectus sem velit orci, rhoncus pharetra facilisis. Cras sodales a,
              dui pellentesque enim odio rutrum leo. Auctor viverra sit sit ut.
              Massa, elit venenatis, ultrices viverra at sagittis, velit. Cursus
              tempus phasellus consectetur suspendisse a blandit pellentesque
              diam neque. Massa est nibh congue elit amet, diam faucibus. Morbi
            ...
            <p>
              Velit parturient tellus tellus, congue pulvinar tellus viverra. In
              cum massa mattis ac. Amet vitae massa ut mi etiam. Auctor aliquam
              tristique felis donec eu sit nisi. Accumsan mauris eget convallis
            ...
            <div className='d-flex align-items-center my-md-5 my-4 py-md-4 py-3 border-top'>
              ...
              <div className='d-flex flex-wrap'>
                <Button
                  size='xs'
                  variant='outline-secondary rounded-pill fs-sm fw-normal'
                  className='me-2 mb-2'
                >
                  Tutorial
                </Button>
            ...
            <div className='mb-4 mb-md-5' id='comments'>
              ...
              {comments.map((comment, indx) => (
                <Comment
                  ...
                  replyLabel='Reply'
                  replyClick={() =>
                    console.log('Hook any action to Reply button!')
                  }
                  className={
                    indx === comments.length - 1 ? 'border-0 pb-0' : ''
                  }
                >
        ...
        <Card className='py-md-4 py-3 shadow-sm'>
          <Card.Body
            ...
            md={10}
            lg={8}
            className='mx-auto px-md-0 px-4'
          >
            ...
            >
              ...
              <Col xs={12}>
                <Button
                  ...
                  size='lg'
                  variant='primary'
                  className='w-sm-auto w-100 mt-2'
                >
                  Post comment
                </Button>
              </Col>
