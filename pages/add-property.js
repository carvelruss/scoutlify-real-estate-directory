                  ...
                  <Collapse in={overviewOpen}>
                    <div id='moreOverview'>
                      <p className='mb-1'>
                        ...
                        obcaecati delectus ducimus inventore tempore harum
        ...
        <Row>
          ...
          <Col lg={8}>
            ...
            >
              ...
              <Form.Label className='fw-bold pt-3 pb-2'>
                Display on the map
              </Form.Label>
              <MapContainer
                ...
                <CustomMarker position={[40.7447, -73.9485]} icon='dot'>
                  <Popup>
                    <div className='p-3'>
                      ...
                      <p className='fs-xs text-muted pt-1 mt-n3 mb-0'>
                        28 Jackson Ave Long Island City, NY
                      </p>
                    </div>
                  </Popup>
                </CustomMarker>
            ...
            <section className='d-sm-flex justify-content-between pt-2'>
              ...
              <Link href='/property-promotion' passHref>
                <Button
                  size='lg'
