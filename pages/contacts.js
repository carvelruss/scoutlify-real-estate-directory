...
const ContactsPage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='Contacts' activeNav='Pages'>
      {/* Breadcrumbs */}
      ...
      <Container as='section' className='mb-5 pb-2 pb-md-4 pb-lg-5'>
        <Row className='gy-4 align-items-md-start align-items-center'>
          <Col xs={12} md={6} lg={5}>
            <div
              className='mx-md-0 mx-auto mb-md-5 mb-4 pb-md-4 text-md-start text-center'
              style={{ maxWidth: '416px' }}
            >
              <h1 className='mb-4'>Get in touch!</h1>
              <p className='mb-0 fs-lg text-muted'>
                Fill out the form and out team will try to get back to you
                within 24 hours.
              </p>
            </div>
            <div className='text-center'>
              <ImageLoader
                src='/images/real-estate/illustrations/contact.svg'
                width={526}
                height={326}
                alt='Illustration'
        ...
        <Row xs={1} md={3} className='g-4'>
          <Col>
            <Card
              ...
              className='icon-box card-hover h-100'
            >
              <Card.Body>
