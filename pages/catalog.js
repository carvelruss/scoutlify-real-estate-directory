  ...
  const markers = [
    {
      ...
      popup: {
        ...
        img:
          categoryParam === 'sale'
            ? '/images/real-estate/catalog/18.jpg'
                  ...
                  <ButtonGroup size='sm'>
                    {bedrooms.map((bedroom, indx) => (
                      <ToggleButton
                        ...
                        onChange={(e) =>
                          setBedroomsValue(e.currentTarget.value)
                        }
                  ...
                  <ButtonGroup size='sm'>
                    {bathrooms.map((bathroom, indx) => (
                      <ToggleButton
                        ...
                        onChange={(e) =>
                          setBathroomsValue(e.currentTarget.value)
                        }
                        variant='outline-secondary fw-normal'
                      >
                        {bathroom.name}
          ...
          >
            ...
            <Breadcrumb className='mb-3 pt-md-2'>
              ...
              <Breadcrumb.Item active>
                Property for {categoryParam === 'sale' ? 'sale' : 'rent'}
              </Breadcrumb.Item>
            </Breadcrumb>
