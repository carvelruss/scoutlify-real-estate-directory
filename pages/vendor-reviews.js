...
const VendorReviewsPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Add review modal */}
      <Modal centered show={reviewModalShow} onHide={handleReviewModalClose}>
        ...
        <Row>
          ...
          <Col md={8} lg={9}>
            ...
            <div className='d-flex align-items-center mb-2 fs-sm'>
              ...
              <span className='text-end ps-2' style={{ minWidth: '48px' }}>
                70%
              </span>
            </div>
            <div className='d-flex align-items-center mb-2 fs-sm'>
            ...
            <div className='d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch justify-content-between border-bottom py-4 mt-3 mb-4'>
              <Form.Group
                controlId='sortby'
                className='d-flex align-items-center me-sm-4 mb-sm-0 mb-3'
              >
