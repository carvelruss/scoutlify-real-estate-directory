  ...
  return (
    <RealEstatePageLayout pageTitle="Home v.1" activeNav="Home">
      ...
      <Container as="section" className="pt-5 my-5 pb-lg-4">
        <Row className="pt-0 pt-md-2 pt-lg-0">
          ...
          <Col
            ...
            lg={6}
            xl={5}
            className="pt-xl-5 pe-lg-0 mb-3 text-md-start text-center"
          >
          ...
          <Col
            ...
            lg={10}
            xl={8}
            className="position-relative mt-lg-n5 zindex-2"
          >
            <FormGroup className="d-block">
              <Row className="g-0 ms-sm-n2">
                ...
                <Col
                  md={4}
                  className="d-sm-flex align-items-center pt-4 pt-md-0"
                >
                  ...
                  <Button variant="primary btn-icon px-3 w-100 w-sm-auto flex-shrink-0">
                    ...
                    <span className="d-sm-none d-inline-block ms-2">
                      Search
                    </span>
                  </Button>
                </Col>
      ...
      <Container as="section" className="mb-5 mt-n3 mt-lg-0">
        ...
        >
          <SwiperSlide>
            <Card className="card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2">
              <div className="d-flex justify-content-center my-3">
                <ImageLoader
                  src="/images/real-estate/illustrations/buy.svg"
                  width={256}
                  height={201}
                  alt="Image"
                />
              ...
              <Card.Body>
                ...
                <p className="card-text fs-sm">
                  Blandit lorem dictum in velit. Et nisi at faucibus mauris
                  pretium enim. Risus sapien nisi aliquam egestas leo dignissim.
                </p>
              </Card.Body>
              <Card.Footer className="pt-0 border-0">
                <Button
                  as={Link}
                  href="/catalog?category=sale"
                  variant="outline-primary stretched-link"
                >
                  Find a home
                </Button>
              </Card.Footer>
          ...
          <SwiperSlide>
            <Card className="card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2">
              <div className="d-flex justify-content-center my-3">
                <ImageLoader
                  src="/images/real-estate/illustrations/sell.svg"
                  width={256}
                  height={201}
                  alt="Image"
                />
              ...
              <Card.Body>
                ...
                <p className="card-text fs-sm">
                  Amet, cras orci justo, tortor nisl aliquet. Enim tincidunt
                  tellus nunc, nulla arcu posuere quis. Velit turpis orci
                  venenatis.
                </p>
              </Card.Body>
              <Card.Footer className="pt-0 border-0">
          ...
          <SwiperSlide>
            <Card className="card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center mx-2">
              ...
              <Card.Body>
                ...
                <p className="card-text fs-sm">
                  Sed sed aliquet sed id purus malesuada congue viverra.
                  Habitant quis lacus, volutpat natoque ipsum iaculis cursus.
                </p>
              </Card.Body>
              <Card.Footer className="pt-0 border-0">
                <Button
        ...
        <div
          id="paginationServices"
          className="swiper-pagination position-relative bottom-0 d-md-none mt-2"
        ></div>
      </Container>
        ...
        <Row className="align-items-center">
          ...
          <Col md={7} xxl={6} className="text-md-start text-center">
            ...
            <p className="pb-3 fs-lg">
              ...
              etc.). Calculate the cost of your property with our new
              Calculation Service.
            </p>
      ...
      <Container as="section" className="mb-5 pb-2">
        <div className="d-flex align-items-center justify-content-between mb-3">
          ...
          <Link
            href="/catalog?category=rent"
            className="btn btn-link fw-normal ms-md-3 pb-0 pe-0"
          >
            View all
            <i className="fi-arrow-long-right ms-2"></i>
          </Link>
            ...
            {cities.map((city, indx) => (
              <SwiperSlide key={indx}>
                <Card
                  as={Link}
                  href={city.href}
                  className="card-hover shadow-sm border-0 mx-2"
                >
                  ...
                  >
                    <div className="mb-2">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <span className="text-light fs-sm ps-1 ms-2">
                          {city.forSale[0]}
                        </span>
                      </div>
                    </div>
      ...
      {/* Top agents (slider) */}
      <Container as="section" className="mb-5 pb-2 pb-lg-4">
        <h2 className="h3 mb-0 pb-2 text-center text-md-start">
          ...
          <SwiperSlide className="bg-light py-4">
            <Row className="align-items-center">
              ...
              <Col
                ...
                md={7}
                xl={4}
                className="px-4 px-sm-3 px-md-0 ms-md-n4 mt-n5 mt-sm-0 py-3"
              >
                <Card className="border-0 shadow-sm ms-sm-n5">
                  <Card.Body as="blockquote" className="blockquote">
                    ...
                    <p className="d-sm-none d-lg-block">
                      ...
                      sit urna. Est volutpat dignissim elementum nec.
                    </p>
            ...
            <Row className="align-items-center">
              ...
              >
                <Card className="border-0 shadow-sm ms-sm-n5">
                  <Card.Body as="blockquote" className="blockquote">
                    <h4 style={{ maxWidth: "22rem" }}>
                      &quot;I don&apos;t say no, I just figure out a way to make
                      it work&quot;
                    </h4>
                    <p className="d-sm-none d-lg-block">
            ...
            <Row className="align-items-center">
              ...
              >
                <Card className="border-0 shadow-sm ms-sm-n5">
                  <Card.Body as="blockquote" className="blockquote">
                    <h4 style={{ maxWidth: "22rem" }}>
                      &quot;Over 10 years of experience as a real estate
                      agent&quot;
                    </h4>
                    <p className="d-sm-none d-lg-block">
