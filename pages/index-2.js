...
const HomeAltPage = () => {
  ...
  return (
    <RealEstatePageLayout pageTitle='Home v.2' activeNav='Home'>
      {/* Property cost calculator modal */}
      ...
      <Container fluid as='section' className='my-5 pt-5 pb-lg-4 px-xxl-4'>
        ...
        >
          <h1 className='display-5 mb-5 pb-md-3 px-md-3 text-white text-center'>
          ...
          <Col md={7} lg={6}>
            <Row className='gy-4'>
              ...
              <Col sm={6} md={{ offset: 1 }}>
                <p className='mb-0'>
                  Viverra a, mauris elit, pretium senectus ut sagittis malesuada
                  lacus. Egestas risus lorem lectus nunc. Aliquet ultrices risus
                  lobortis cursus vel blandit magna. Eu donec hendrerit morbi
                  tortor.
                </p>
              </Col>
            </Row>
            ...
            <Row
              xs={1}
              sm={3}
              className='gy-4 gx-lg-5 gx-3 text-center px-lg-4'
            >
              <Col>
              ...
              <Col>
                ...
                <span className='fs-sm'>
                  Average annual earnings per landlord
                </span>
              </Col>
            </Row>
          </Col>
          ...
          {recentProperties.map((property, indx) => (
            <SwiperSlide key={indx} className='bg-light py-4'>
              <Row>
                ...
                <Col md={5} lg={4}>
                  <span className='d-inline-block fs-sm text-uppercase text-primary mb-2 from-top'>
                    {property.category}
                  </span>
      ...
      <Container as='section' className='mb-5 pb-lg-5 pb-4'>
        <div className='d-flex align-items-start justify-content-between mb-3 mb-md-4 pb-md-2'>
          <div className='d-flex flex-md-row flex-column align-items-center'>
            ...
            <Nav
              as='ul'
              variant='tabs'
              defaultActiveKey='forRent'
              className='mb-0 ms-md-4 ms-n3 ps-lg-2'
            >
              <Nav.Item as='li'>
        ...
        <div
          ...
          className='swiper-pagination position-relative bottom-0 d-md-none py-2 mt-2'
        ></div>
      </Container>

      {/* Top properties */}
      <Container fluid className='px-xxl-4 pb-lg-4 pb-1 mb-5 mt-n3'>
        <h2 className='h3 mb-lg-4 pb-3 text-center'>
              ...
              <Row className='gy-md-0 gy-sm-4 gy-3 gx-sm-4 gx-0'>
                <Col md={7}>
                  <Card
                    ...
                    style={{
                      minHeight: '18.75rem',
                      backgroundImage: `url(${property[0].img})`,
                    }}
                  >
      ...
      <Container as='section' className='mb-5 pb-lg-5 pb-md-4'>
        <Card className='border-0 bg-secondary py-lg-5 py-4'>
          <Card.Body className='text-center p-4'>
            ...
            <p
              className='mx-auto mb-md-5 mb-4 pb-lg-3'
              style={{ maxWidth: '53.125rem' }}
            >
              We have the most comprehensive directory of estate agents to help
              you with all your property needs. Whether buying, selling or
              renting start your search to find the right local expertise.
            </p>
            <div className='d-flex align-items-center justify-content-center flex-wrap mb-md-5 mb-4 pb-lg-3 ps-3 pt-4'>
              {agents.map((agent, indx) => (
                <div
                  key={indx}
                  className='d-flex position-relative border border-5 border-white rounded-circle bg-white ms-n3 mt-n4'
                  style={{ width: 120, height: 120, zIndex: indx + 1 }}
                >
                  <ImageLoader
                    src={agent}
                    width={220}
      ...
      {/* Blog (latest posts) */}
      <Container as='section' className='mb-5 pb-lg-5 pb-4'>
        <h2 className='h3 mb-4 pb-2 text-md-start text-center'>
        ...
        <Row className='gy-5'>
          <Col lg={7}>
            ...
            <div className='pt-2'>
              <Button
                ...
                href='/blog'
                size='lg'
                variant='outline-primary w-sm-auto w-100'
              >
                More blog posts
              </Button>
            </div>
          ...
          <Col lg={4}>
            <Row
              ...
              md={2}
              lg={1}
              className='gy-5 text-md-start text-center'
            >
              {/* Subscription */}
              ...
              <Col>
                ...
                <p className='mb-4'>
                  Get the latest news and inspiration about the housing market.
                </p>
          ...
          <Col>
            <Card className='card-hover h-100 border-0 bg-faded-warning position-relative'>
              ...
              <Card.Footer className='py-1 border-0'>
                <Button
                  variant='link stretched-link text-warning mb-3 px-0'
          ...
          <Col>
            <Card className='card-hover h-100 border-0 bg-faded-accent position-relative'>
              ...
              <Card.Footer className='py-1 border-0'>
                <Button
                  as={Link}
                  href='/real-state/help-center'
                  variant='link stretched-link text-accent mb-3 px-0'
                >
                  Go to FAQs
                </Button>
              </Card.Footer>
          ...
          <Col>
            <Card className='card-hover h-100 border-0 bg-faded-success position-relative'>
              <Card.Body className='pb-2'>
                ...
                <p className='mb-0'>
                  Here is a step-by-step guide for renters.
                </p>
              </Card.Body>
              <Card.Footer className='py-1 border-0'>
                <Button
                  as={Link}
                  href='/real-state/about'
                  variant='link stretched-link text-success mb-3 px-0'
                >
                  Get started
                </Button>
              </Card.Footer>
